...
$select = mysqli_query($conn, "select * from produk where id_produk=$id");
...
?>
        ...
        <select class="form-control ml-auto" name="kategori" required>
            <option <?php if ($kategori == "Rifles") {
                        echo "selected";
                    } ?>>Rifles</option>
            <option <?php if ($kategori == "Sniper Rifles") {
                        echo "selected";
                    } ?>>Sniper Rifles</option>
            <option <?php if ($kategori == "Machine Guns") {
                        echo "selected";
                    } ?>>Machine Guns</option>
            <option <?php if ($kategori == "Grenade Launcher") {
                        echo "selected";
                    } ?>>Grenade Launcher</option>
            <option <?php if ($kategori == "Mortir") {
                        echo "selected";
                    } ?>>Mortir</option>
            <option <?php if ($kategori == "Pistols") {
                        echo "selected";
                    } ?>>Pistols</option>
            <option <?php if ($kategori == "Shotguns") {
                        echo "selected";
                    } ?>>Shotguns</option>
            <option <?php if ($kategori == "Submachine Guns") {
                        echo "selected";
                    } ?>>Submachine Guns</option>
        </select>
    <?php
        add_spesifikasi();
        add_deskripsi();
    ...
    ?>
        <label>Kategori</label>
        <select class="form-control ml-auto" name="kategori" required>
            <option <?php if ($kategori == "Small Caliber") {
                        echo "selected";
                    } ?>>Small Caliber</option>
            <option <?php if ($kategori == "Big Caliber") {
                        echo "selected";
                    } ?>>Big Caliber</option>
            <option <?php if ($kategori == "Special Ammunition") {
                        echo "selected";
                    } ?>>Special Ammunition</option>
        </select>
    <?php
        add_spesifikasi();
        add_deskripsi();
    ...
    ?>
        <label>Kategori</label>
        <select class="form-control ml-auto" name="kategori" required>
            <option <?php if ($kategori == "4 x 4 Komodo") {
                        echo "selected";
                    } ?>>4 x 4 Komodo</option>
            <option <?php if ($kategori == "6 x 6 Anoa") {
                        echo "selected";
                    } ?>>6 x 6 Anoa</option>
        </select>
    <?php
    ...
    ?>
        <label>Kategori</label>
        <select class="form-control ml-auto" name="kategori" required>
            <option <?php if ($kategori == "Electric Machines") {
                        echo "selected";
                    } ?>>Electric Machines</option>
            <option <?php if ($kategori == "Agricultural Machines") {
                        echo "selected";
                    } ?>>Agricultural Machines</option>
        </select>
    <?php
        add_spesifikasi();
        add_deskripsi();
    ...
    ?>
        <label>Kategori</label>
        <select class="form-control ml-auto" name="kategori" required>
            <option <?php if ($kategori == "Forging") {
                        echo "selected";
                    } ?>>Forging</option>
            <option <?php if ($kategori == "Casting") {
                        echo "selected";
                    } ?>>Casting</option>
            <option <?php if ($kategori == "Railway Equipment") {
                        echo "selected";
                    } ?>>Railway Equipment</option>
            <option <?php if ($kategori == "Ship Equipment") {
                        echo "selected";
                    } ?>>Ship Equipment</option>
        </select>
    <?php
        add_spesifikasi();
        add_deskripsi();
    ...
    ?>
        <label>Kategori</label>
        <select class="form-control ml-auto" name="kategori" required>
            <option <?php if ($kategori == "Explosive") {
                        echo "selected";
                    } ?>>Explosive</option>
            <option <?php if ($kategori == "Explosive Services") {
                        echo "selected";
                    } ?>>Explosive Services</option>
        </select>
    <?php
        add_spesifikasi();
        add_deskripsi();
    ...
    ?>
        <label>Kategori</label>
        <select class="form-control ml-auto" name="kategori" required>
            <option <?php if ($kategori == "PT.PEI") {
                        echo "selected";
                    } ?>>PT.PEI</option>
            <option <?php if ($kategori == "PT. PGST") {
                        echo "selected";
                    } ?>>PT. PGST</option>
            <option <?php if ($kategori == "PT. PMU") {
                        echo "selected";
                    } ?>>PT. PMU</option>
        </select>
    <?php
    ...
    ?>
        <label>Kategori</label>
        <select class="form-control ml-auto" name="kategori" required>
            <option <?php if ($kategori == "Bulletin") {
                        echo "selected";
                    } ?>>Bulletin</option>
            <option <?php if ($kategori == "Newsletter") {
                        echo "selected";
                    } ?>>Newsletter</option>
        </select>
<?php
